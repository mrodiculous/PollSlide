...
### Stage 2 — Middle grade (in progress)
**Shipped 2026-07-04:** copy/paste elements & whole slides (⌘C/⌘V) · multi-select (shift-click, group drag, group nudge/delete/duplicate) · drag-reorder slide navigator · element opacity + rotation (15° steps, ⇧-reset) · lock element · line shape (rotate for dividers/arrows) · ⌘D duplicates selection.
**Remaining:** text style presets (H1/H2/body) · bullet lists · image crop/fit modes · per-slide background image · hyperlinks in text · grid & guides toggle · basic tables.
