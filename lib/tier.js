...
// 'enterprise' is admin-assigned only — see api/watchdog.js's tier_drift check, which
// exempts it for the same reason comps are exempted: no Stripe subscription drives it,
// so comparing it against one would be comparing against nothing and "fixing" it away.
const VALID_TIERS = ['free', 'pro', 'team_small', 'team_large', 'enterprise'];
