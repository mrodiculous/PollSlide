...
const TIERS = {
  ...
  // Admin-assigned only, no Stripe price — see the matching entry in presenter.html's
  // TIERS for why the limits are generous defaults rather than a negotiated ceiling.
  enterprise: { name: 'Enterprise', maxPresentations: Infinity, maxParticipants: Infinity, maxMembers: Infinity, aiMonthly: -1 },
};
