...
async function checkQuota(req) {
  ...
  if (limit >= 0 && used >= limit) {
    throw { code: 429, error: `You've used all ${limit} Polly generations on the ${tier} plan this month. Upgrade for more.`, overLimit: true, limit, used, tier };
  }
  return { uid: who.uid, ref, month };
}
