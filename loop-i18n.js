...
/* ── Studio: Polly writes the whole round ────────────────────────────────── */
LoopI18n.add([
['Describe a topic and Polly writes the round for you — questions with emojis, fun-fact cards and, if you like, a picture for each question. You can edit everything before you publish. Everything Polly makes is labelled “AI-generated” on screen.','Describe un tema y Polly escribe la ronda por ti: preguntas con emojis, tarjetas de curiosidades y, si quieres, una imagen para cada pregunta. Puedes editarlo todo antes de publicar. Todo lo que crea Polly se marca como “Generado con IA” en pantalla.','Beschreib ein Thema, und Polly schreibt die Runde für dich – Fragen mit Emojis, Fun-Fact-Karten und auf Wunsch ein Bild zu jeder Frage. Du kannst vor dem Veröffentlichen alles bearbeiten. Alles, was Polly erstellt, ist auf dem Bildschirm als „KI-generiert“ gekennzeichnet.','Décris un sujet et Polly écrit la manche pour toi — questions avec emojis, cartes « le savais-tu ? » et, si tu veux, une image pour chaque question. Tu peux tout modifier avant de publier. Tout ce que crée Polly est signalé « Généré par IA » à l’écran.','Descreva um tema e o Polly escreve a ronda por si — perguntas com emojis, cartões de curiosidades e, se quiser, uma imagem para cada pergunta. Pode editar tudo antes de publicar. Tudo o que o Polly cria aparece identificado como “Gerado por IA” no ecrã.','Descrivi un argomento e Polly scrive il round per te: domande con emoji, schede di curiosità e, se vuoi, un’immagine per ogni domanda. Puoi modificare tutto prima di pubblicare. Tutto ciò che crea Polly è etichettato “Generato con IA” sullo schermo.'],
['Add a “💡 Did you know?” card after every few questions','Añadir una tarjeta “💡 ¿Sabías que…?” cada pocas preguntas','Nach ein paar Fragen eine „💡 Schon gewusst?“-Karte einfügen','Ajouter une carte « 💡 Le savais-tu ? » toutes les quelques questions','Acrescentar um cartão “💡 Sabia que…?” a cada poucas perguntas','Aggiungi una scheda “💡 Lo sapevi?” ogni poche domande'],
['Add a Polly picture to each question','Añadir una imagen de Polly a cada pregunta','Zu jeder Frage ein Bild von Polly hinzufügen','Ajouter une image de Polly à chaque question','Acrescentar uma imagem do Polly a cada pergunta','Aggiungi un’immagine di Polly a ogni domanda'],
['Each picture uses one Polly credit from your plan.','Cada imagen usa un crédito de Polly de tu plan.','Jedes Bild verbraucht ein Polly-Guthaben deines Tarifs.','Chaque image utilise un crédit Polly de ton forfait.','Cada imagem usa um crédito do Polly do seu plano.','Ogni immagine usa un credito Polly del tuo piano.'],
['💡 Did you know?','💡 ¿Sabías que…?','💡 Schon gewusst?','💡 Le savais-tu ?','💡 Sabia que…?','💡 Lo sapevi?'],
['Polly is drawing {n} of {m}…','Polly está dibujando {n} de {m}…','Polly zeichnet {n} von {m}…','Polly dessine {n} sur {m}…','O Polly está a desenhar {n} de {m}…','Polly sta disegnando {n} di {m}…'],
['Polly’s allowance ran out after {n} picture(s).','El cupo de Polly se agotó tras {n} imagen(es).','Das Polly-Kontingent war nach {n} Bild(ern) aufgebraucht.','Le quota Polly est épuisé après {n} image(s).','A quota do Polly esgotou-se após {n} imagem(ns).','La quota di Polly si è esaurita dopo {n} immagine/i.'],
['Polly added {n} picture(s).','Polly añadió {n} imagen(es).','Polly hat {n} Bild(er) hinzugefügt.','Polly a ajouté {n} image(s).','O Polly acrescentou {n} imagem(ns).','Polly ha aggiunto {n} immagine/i.'],
]);

/* ── Game extras (phones, TV, Studio) ───────────────────────────────────── */
LoopI18n.add([
['Pick your team','Elige tu equipo','Wähl dein Team','Choisis ton équipe','Escolha a sua equipa','Scegli la tua squadra'],
['Top {n} win: {x}','Los {n} primeros ganan: {x}','Die Top {n} gewinnen: {x}','Les {n} premiers gagnent : {x}','Os {n} primeiros ganham: {x}','I primi {n} vincono: {x}'],
['Double points — once per round','Puntos dobles: una vez por ronda','Doppelte Punkte – einmal pro Runde','Points doublés — une fois par manche','Pontos a dobrar — uma vez por ronda','Punti doppi — una volta per round'],
['🔥 {n} days in a row — come back tomorrow to keep it going!','🔥 {n} días seguidos: ¡vuelve mañana para mantener la racha!','🔥 {n} Tage in Folge – komm morgen wieder, damit die Serie hält!','🔥 {n} jours d’affilée — reviens demain pour continuer la série !','🔥 {n} dias seguidos — volte amanhã para manter a sequência!','🔥 {n} giorni di fila — torna domani per continuare la serie!'],
['Your team {x} is #{n} of {m}.','Tu equipo {x} va #{n} de {m}.','Dein Team {x} ist auf Platz {n} von {m}.','Ton équipe {x} est {n}e sur {m}.','A sua equipa {x} está em {n}.º de {m}.','La tua squadra {x} è {n}ª su {m}.'],
['Share my rank','Compartir mi puesto','Meinen Platz teilen','Partager mon classement','Partilhar a minha posição','Condividi la mia posizione'],
['🏅 New badge: {x}','🏅 Nueva insignia: {x}','🏅 Neues Abzeichen: {x}','🏅 Nouveau badge : {x}','🏅 Novo distintivo: {x}','🏅 Nuovo badge: {x}'],
['First answer','Primera respuesta','Erste Antwort','Première réponse','Primeira resposta','Prima risposta'],
['Hot streak — 3 in a row','Racha: 3 seguidas','Heiße Serie – 3 in Folge','Série chaude — 3 d’affilée','Sequência quente — 3 seguidas','Serie calda — 3 di fila'],
['On fire — 5 in a row','Imparable: 5 seguidas','Auf Feuer – 5 in Folge','En feu — 5 d’affilée','Em chamas — 5 seguidas','In fiamme — 5 di fila'],
['Unstoppable — 10 in a row','Invencible: 10 seguidas','Unaufhaltsam – 10 in Folge','Inarrêtable — 10 d’affilée','Imparável — 10 seguidas','Inarrestabile — 10 di fila'],
['Perfect round','Ronda perfecta','Perfekte Runde','Manche parfaite','Ronda perfeita','Round perfetto'],
['Fastest finger','El más rápido','Schnellster Finger','Doigt le plus rapide','Dedo mais rápido','Dito più veloce'],
['Made the podium','En el podio','Auf dem Podest','Sur le podium','No pódio','Sul podio'],
['Took the crown','Se llevó la corona','Die Krone geholt','A pris la couronne','Ficou com a coroa','Ha preso la corona'],
['3 days in a row','3 días seguidos','3 Tage in Folge','3 jours d’affilée','3 dias seguidos','3 giorni di fila'],
['7 days in a row','7 días seguidos','7 Tage in Folge','7 jours d’affilée','7 dias seguidos','7 giorni di fila'],
['{n} days in a row','{n} días seguidos','{n} Tage in Folge','{n} jours d’affilée','{n} dias seguidos','{n} giorni di fila'],
['Send a reaction to the screen','Enviar una reacción a la pantalla','Eine Reaktion an den Bildschirm senden','Envoyer une réaction à l’écran','Enviar uma reação para o ecrã','Invia una reazione allo schermo'],
['You’re in the top {n}!','¡Estás entre los {n} primeros!','Du bist in den Top {n}!','Tu es dans le top {n} !','Está no top {n}!','Sei tra i primi {n}!'],
['Show this screen to the staff.','Enseña esta pantalla al personal.','Zeig diesen Bildschirm dem Personal.','Montre cet écran au personnel.','Mostre este ecrã aos funcionários.','Mostra questa schermata allo staff.'],
['of {n} players · {p} points','de {n} jugadores · {p} puntos','von {n} Spielern · {p} Punkte','sur {n} joueurs · {p} points','de {n} jogadores · {p} pontos','su {n} giocatori · {p} punti'],
['Scan to play · LoopSlide by PollSlide','Escanea para jugar · LoopSlide by PollSlide','Scannen und mitspielen · LoopSlide by PollSlide','Scanne pour jouer · LoopSlide by PollSlide','Leia para jogar · LoopSlide by PollSlide','Scansiona per giocare · LoopSlide by PollSlide'],
['I’m #{n} at {x}! Can you beat me?','¡Voy #{n} en {x}! ¿Me superas?','Ich bin auf Platz {n} bei {x}! Schaffst du mehr?','Je suis {n}e à {x} ! Tu peux faire mieux ?','Estou em {n}.º em {x}! Consegue ultrapassar-me?','Sono {n}° a {x}! Riesci a battermi?'],
['Save the image','Guardar la imagen','Bild speichern','Enregistrer l’image','Guardar a imagem','Salva l’immagine'],
['Players','Jugadores','Spieler','Joueurs','Jogadores','Giocatori'],
['Teams','Equipos','Teams','Équipes','Equipas','Squadre'],
['🎮 Game extras','🎮 Extras del juego','🎮 Spiel-Extras','🎮 Bonus de jeu','🎮 Extras do jogo','🎮 Extra di gioco'],
['The things that keep a room playing. Switch off anything that doesn\'t suit your venue.','Lo que mantiene a la sala jugando. Desactiva lo que no encaje con tu local.','Was einen Raum am Spielen hält. Schalte ab, was nicht zu deinem Lokal passt.','Ce qui fait jouer toute la salle. Désactive ce qui ne convient pas à ton établissement.','O que mantém a sala a jogar. Desligue o que não se adequar ao seu espaço.','Ciò che fa giocare tutta la sala. Disattiva quello che non si adatta al tuo locale.'],
['Live emoji reactions — players send 👏 🔥 😂 to the TV','Reacciones con emoji en directo: los jugadores envían 👏 🔥 😂 a la tele','Live-Emoji-Reaktionen – Spieler schicken 👏 🔥 😂 an den Fernseher','Réactions emoji en direct — les joueurs envoient 👏 🔥 😂 à la télé','Reações com emoji ao vivo — os jogadores enviam 👏 🔥 😂 para a televisão','Reazioni emoji live — i giocatori mandano 👏 🔥 😂 alla TV'],
['⚡ Double points — each player can use it once per round','⚡ Puntos dobles: cada jugador puede usarlo una vez por ronda','⚡ Doppelte Punkte – jeder Spieler einmal pro Runde','⚡ Points doublés — chaque joueur peut l’utiliser une fois par manche','⚡ Pontos a dobrar — cada jogador pode usar uma vez por ronda','⚡ Punti doppi — ogni giocatore può usarli una volta per round'],
['🏅 Badges — hot streaks, perfect rounds, fastest finger and more','🏅 Insignias: rachas, rondas perfectas, el más rápido y más','🏅 Abzeichen – Serien, perfekte Runden, schnellster Finger und mehr','🏅 Badges — séries, manches parfaites, doigt le plus rapide et plus','🏅 Distintivos — sequências, rondas perfeitas, dedo mais rápido e mais','🏅 Badge — serie, round perfetti, dito più veloce e altro'],
['👥 Table vs table — players join a team and teams get their own leaderboard','👥 Mesa contra mesa: los jugadores se unen a un equipo y los equipos tienen su propia clasificación','👥 Tisch gegen Tisch – Spieler treten einem Team bei, und Teams bekommen eine eigene Rangliste','👥 Table contre table — les joueurs rejoignent une équipe et les équipes ont leur propre classement','👥 Mesa contra mesa — os jogadores entram numa equipa e as equipas têm a sua própria classificação','👥 Tavolo contro tavolo — i giocatori entrano in una squadra e le squadre hanno la loro classifica'],
['Team names (one per line, up to 12)','Nombres de los equipos (uno por línea, hasta 12)','Teamnamen (einer pro Zeile, bis zu 12)','Noms des équipes (un par ligne, jusqu’à 12)','Nomes das equipas (um por linha, até 12)','Nomi delle squadre (uno per riga, fino a 12)'],
['🎁 Reward for the top players (optional)','🎁 Recompensa para los mejores (opcional)','🎁 Belohnung für die Besten (optional)','🎁 Récompense pour les meilleurs (facultatif)','🎁 Recompensa para os melhores (opcional)','🎁 Premio per i migliori (facoltativo)'],
['e.g. 10% off your next round','p. ej., 10% de descuento en tu próxima ronda','z. B. 10 % Rabatt auf deine nächste Runde','ex. 10 % de réduction sur ta prochaine tournée','ex.: 10% de desconto na próxima bebida','es. 10% di sconto sul prossimo giro'],
['Code to show staff, e.g. WIN10','Código para el personal, p. ej., WIN10','Code fürs Personal, z. B. WIN10','Code à montrer au personnel, ex. WIN10','Código para os funcionários, ex.: WIN10','Codice da mostrare allo staff, es. WIN10'],
['Top {n}','Top {n}','Top {n}','Top {n}','Top {n}','Top {n}'],
['Players in the top places see the reward, the code, their name and a live clock on their phone, so staff can tell it\'s real. A reward is a prize: add your official rules below.','Los primeros ven la recompensa, el código, su nombre y un reloj en directo en el móvil, para que el personal sepa que es real. Una recompensa es un premio: añade tus bases oficiales abajo.','Die Besten sehen die Belohnung, den Code, ihren Namen und eine laufende Uhr auf dem Handy – so erkennt das Personal, dass es echt ist. Eine Belohnung ist ein Preis: Füg unten deine Teilnahmebedingungen hinzu.','Les premiers voient la récompense, le code, leur nom et une horloge en direct sur leur téléphone, pour que le personnel sache que c’est authentique. Une récompense est un lot : ajoute ton règlement ci-dessous.','Os primeiros veem a recompensa, o código, o nome e um relógio ao vivo no telemóvel, para os funcionários saberem que é real. Uma recompensa é um prémio: acrescente o regulamento oficial abaixo.','I primi vedono il premio, il codice, il loro nome e un orologio live sul telefono, così lo staff sa che è autentico. Un premio va regolamentato: aggiungi qui sotto il regolamento ufficiale.'],
['Table {n}','Mesa {n}','Tisch {n}','Table {n}','Mesa {n}','Tavolo {n}'],
]);

/* ── Paused by PollSlide support ─────────────────────────────────────────── */
LoopI18n.add([
['This screen is paused.','Esta pantalla está en pausa.','Dieser Bildschirm ist pausiert.','Cet écran est en pause.','Este ecrã está em pausa.','Questo schermo è in pausa.'],
['This game is paused.','Esta partida está en pausa.','Dieses Spiel ist pausiert.','Cette partie est en pause.','Este jogo está em pausa.','Questa partita è in pausa.'],
['Check back later.','Vuelve más tarde.','Schau später wieder vorbei.','Reviens plus tard.','Volte mais tarde.','Torna più tardi.'],
['Paused by PollSlide support','En pausa por el soporte de PollSlide','Vom PollSlide-Support pausiert','Mis en pause par le support PollSlide','Em pausa pelo suporte PollSlide','Messo in pausa dal supporto PollSlide'],
['Screens and phones show “paused” until support resumes it. Questions? help@pollslide.com','Las pantallas y los móviles muestran “en pausa” hasta que el soporte lo reanude. ¿Dudas? help@pollslide.com','Bildschirme und Handys zeigen „pausiert“, bis der Support es fortsetzt. Fragen? help@pollslide.com','Les écrans et les téléphones affichent « en pause » jusqu’à ce que le support le relance. Des questions ? help@pollslide.com','Os ecrãs e os telemóveis mostram “em pausa” até o suporte o retomar. Dúvidas? help@pollslide.com','Schermi e telefoni mostrano “in pausa” finché il supporto non lo riprende. Domande? help@pollslide.com'],
]);
